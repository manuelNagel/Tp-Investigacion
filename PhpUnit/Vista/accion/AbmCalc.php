<?php require_once "./PhpUnit/Modelo/Calculadora.php";
...
if (isset($_POST['submit'])) {
    ...
    if (is_numeric($_POST['number1']) && is_numeric($_POST['number2'])) {
        ...
        // 
        $mensaje= "<h1>{$_POST['number1']} {$_POST['operation']} {$_POST['number2']} equals {$total}</h1>";

    } else {

        // Print error message to the browser
        $mensaje = 'Numeric values are required';
    }
}
?>
<?= $mensaje ?>